		                ...
		                <div class="text-center p-5 mt-5">
		                    <figure class="avatar avatar-xl">
		                    	<c:choose>
				                    ...
				                    <c:otherwise>
				                    	<a href="obtener_usuario?nombre=${usuario.getCorreo()}&pagina=10">
				                    </c:otherwise>
				                </c:choose>
				                    	<c:choose>
													...
													<div style="margin-bottom: -1px;" class="cancion">
														<li class="list-group-item my-1">																
															<div class="d-flex align-items-center">
																...
																<a href="anyadir_cancion_fav?idAudio=${cancion.getId()}&pagina=10" class="btn-favorito icon-star active" ></a>
