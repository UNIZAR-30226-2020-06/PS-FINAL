 ...
 */
@WebServlet("/AndroidEliminar_UsuarioServlet")
public class AndroidEliminar_UsuarioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    public AndroidEliminar_UsuarioServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		getServletContext().log("--- ~AndroidEliminar_UsuarioServlet~ ---");
