...
/**
 * Servlet implementation class AndroidUnfollow_UsuarioServlet
 */
@WebServlet("/AndroidUnfollow_UsuarioServlet")
public class AndroidUnfollow_UsuarioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AndroidUnfollow_UsuarioServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().log("--- ~AndroidUnollow_UsuarioServlet~ ---");
