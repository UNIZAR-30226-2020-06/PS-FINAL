 ...
 */
@WebServlet("/AndroidSubir_AudioServlet")
public class AndroidSubir_AudioServlet extends HttpServlet {
     ...
     */
    public AndroidSubir_AudioServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().log("--- ~AndroidSubir_AudioServlet~ ---");
		
        JSONObject parametrosPeticion = JSONAdapter.parsarJSON(request);
        getServletContext().log("Parametros: song" + parametrosPeticion.getString("nombreCancion") + "," + parametrosPeticion.getString("generoCancion") + "," + parametrosPeticion.getString("email"));
        
        String cancion = parametrosPeticion.getString("cancion");
