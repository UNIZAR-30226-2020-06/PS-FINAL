...
/**
 * Servlet implementation class AndroidAnyadir_CapituloPodcastServlet
 */
@WebServlet("/AndroidAnyadir_CapituloPodcastServlet")
public class AndroidAnyadir_CapituloPodcastServlet extends HttpServlet {
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AndroidAnyadir_CapituloPodcastServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().log("--- ~AndroidAnyadir_CapituloListaServlet~ ---");
